...
The C6000 Code Generation Tools Release v7.3.0 contains an early adopter
...
Enter the version 7.3.0 in the "Release/Version" section.
...
the v7.3.0 release was installed (prelink_dyn_exe, prelink_dependents, 
